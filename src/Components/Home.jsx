...
const Home = () => {
  ...
  relative min-h-screen box-border flex flex-col items-center justify-center text-white overflow-hidden">
        ...
        {(player.length === 0 && mode.length === 0) && (
          <div className="mt-17.5 flex flex-col md:flex-row items-center justify-center gap-8 p-6 max-w-4xl mx-auto">
            <motion.div
            ...
            >
              <div className="relative p-1 border-4 border-[#6e63c4] w-64 h-auto bg-yellow-500 rounded-2xl shadow-lg">
                ...
                <div className="relative rounded-t-2xl h-28 bg-blue-700 flex items-center justify-center overflow-hidden">
                  ...
                  {/* Left Phone */}
                  <div className="absolute left-2 top-1/3 -translate-y-1/2 w-12 h-16 rounded-xl shadow-md text-[70px] text-center mb-4">📱</div>
                  {/* Right Phone */}
                  <div className="absolute right-5 top-1/3 -translate-y-1/2 w-12 h-16 rounded-xl shadow-md text-[70px] text-center mb-4">📱</div>
            ...
            <motion.div
              className="relative cursor-pointer rounded-2xl shadow-lg w-full overflow-hidden group hover:scale-105 transition-transform duration-300"
              initial={{ scale: 0.95, opacity: 0, y: 20 }}
              animate={{ scale: 1, opacity: 1, y: 0 }}
